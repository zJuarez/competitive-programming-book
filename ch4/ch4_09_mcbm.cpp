...
int main() {
  ...
  /*
    ...
    numbered 0,1,2, right side 3,4,5 int V = 6, Vleft = 3, set1[3] = {1,7,11},
    set2[3] = {4,10,12};
    ...
    needed AdjList.assign(V, vi()); for (int i = 0; i < Vleft; i++) for (int j =
    0; j < 3; j++) if (isprime(set1[i] + set2[j])) AdjList[i].push_back(3 + j);
  */
